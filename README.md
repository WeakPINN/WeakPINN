...
│   ├── tools/            analysis, validation, viz
│   ├── final_results/    curated paper-ready metrics
│   └── README.md
├── frap/                 FRAP weak-form PINN cross-domain validation
│   ├── src/              models + losses
│   ├── scripts/          data, training, analysis
│   ├── tests/
│   ├── results/          curated supplement tables
│   ├── figures/          publication figures
│   └── README.md
├── docs/                 shared methodology notes (weak-form derivation)
