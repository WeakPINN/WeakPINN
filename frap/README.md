...
│   ├── make_main_figures.py           Figures 5 + 6 (main text)
...
├── results/                           curated CSVs (per-stack quality, LS reference, supplement tables)
└── figures/                           main figures (figure5/6_*.png) + supplement/
```
