...
def figure_sfrap1():
    ...
    fig.suptitle("Figure S-FRAP1  |  DeepFRAP data audit and selected experimental stacks",
...
def figure_sfrap2():
    ...
    fig.suptitle(r"Figure S-FRAP2  |  Per-method $\lambda_{\mathrm{phys}}$ tuning on clean synthetic (10k steps)",
...
def figure_sfrap3():
    ...
    fig.suptitle("Figure S-FRAP3  |  Reconstruction error is comparable across methods",
...
def figure_sfrap4():
    ...
    fig.suptitle("Figure S-FRAP4  |  Fair residual diagnostics: both metrics on both models",
                 fontsize=12, fontweight="bold")
...
def figure_sfrap5():
    ...
    ax.grid(axis="y", which="both", linestyle=":", alpha=0.4)
    fig.suptitle("Figure S-FRAP5  |  All 66 Phase 9 runs, per-seed",
                 fontsize=12, fontweight="bold")
    fig.tight_layout(rect=[0, 0, 1, 0.95])
