...
def make_figure5():
    ...
    ax_D.text(-0.16, 1.08, "D", transform=ax_D.transAxes,
              fontsize=14, fontweight="bold")
    fig.suptitle("Figure 4  |  Controlled FRAP diffusion recovery",
                 fontsize=12, y=0.99, fontweight="bold")
    fig.savefig("figures/figure4_synthetic.png", bbox_inches="tight")
...
def make_figure6():
    ...
    fig.suptitle("Figure 5  |  Experimental FRAP validation across 10 stacks (5 per condition)",
                 fontsize=13, y=1.00, fontweight="bold")
    fig.subplots_adjust(left=0.05, right=0.985, top=0.87, bottom=0.14,
                        wspace=0.32)
    fig.savefig("figures/figure5_real.png", bbox_inches="tight")
